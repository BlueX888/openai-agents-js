...
- a0f48ff: fix: Preserve the requested working directory for Cloudflare and Runloop shell command lists and stop execution if the directory transition fails.
